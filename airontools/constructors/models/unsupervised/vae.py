...
class ImageVAE(Model):
    def __init__(self, latent_dim, **kwargs):
        ...
        z_mean = layer_constructor(
            encoder_conv, name="z_mean", units=latent_dim, advanced_reg=True
        )
        z_log_var = layer_constructor(
            encoder_conv, name="z_log_var", units=latent_dim, advanced_reg=True
        )
    ...
    def train_step(self, data):
        loss, reconstruction_loss, kl_loss, tape = self.loss_evaluation(
            data, return_tape=True
        )
